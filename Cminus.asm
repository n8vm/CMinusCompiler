...
#Symbol table used by previous mutable: []
...
#Symbol table used by previous mutable: []
	...
	addi $sp, $sp, 20		#Reverting parameter scope...
	jr $ra
	addi $sp, $sp, 8		#Reverting parameter scope...
	# Restore registers
	lw $s1, -20($sp)
	lw $s0, -16($sp)
main:
	addi $sp, $sp, -4 #Accounting for the global AR table.
...
#Symbol table used by previous mutable: [b, x]
	li $v0, 1
	move $a0, $s0
	syscall
	li $v0, 4
...
#Symbol table used by previous mutable: [b, x]
	...
	la $a0, newline
	syscall
	addi $sp, $sp, -8		#Entering parameter scope...
	lw $s0, 20($sp)		#Loading mutable.
#Symbol table used by previous mutable: [c]
